...
""" Adapted from 'https://github.com/carter-yagemann/python-fuzzy-extractor'"""
...
class FuzzyExtractor(object):
    ...
    def __init__(self, length, ham_err, rep_err=0.001, **locker_args):
        ...
        bits = length * 8
        #print(f"ham err {ham_err} and log bits {log(bits)}")
    ...
    def generate(self, value):
        ...
        # fromstring is deprecated so use frombuffer
